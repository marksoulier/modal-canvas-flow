              ...
              <div className="text-center max-w-md mx-auto">
                ...
                <div className="mt-6">
                  <p className="text-sm text-muted-foreground">
                    {isHighIncome ? 'Premium features provide excellent value at your income level' : 'Start with our free plan to build your financial foundation'}
                  </p>
                </div>
              </div>
            </div>
